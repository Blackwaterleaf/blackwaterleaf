...
export const WORLD_CHOICES: WorldChoice[] = [
  {
    ...
    href: "/plants",
    icon: Leaf,
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663783480419/qmloFTGSjCFRoVJv.jpg",
  },
  {
    id: "aquarium",
    label: "Aquaristik",
    ...
    href: "/aquariums",
    icon: Waves,
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663783480419/IdfRorWpbjjRkmWY.jpg",
  },
  {
    id: "terrarium",
    label: "Terraristik",
    ...
    href: "/discover",
    icon: Sprout,
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663783480419/JyzIvRjtPdIvwWWD.jpg",
  },
  {
    id: "ai",
    label: "KI-Assistent",
    ...
    href: "/ai",
    icon: Bot,
    image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663783480419/PSZueuRMSmSZbPaL.jpg",
  },
];
